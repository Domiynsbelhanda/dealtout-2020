...
@section('title','DealTout || A Propos')
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							@endphp
							<h3>Bienvenue sur <span>DealTout</span></h3>
					...
					<div class="col-lg-6 col-12">
						<div class="about-img overlay">
							...
							<img src="@foreach($settings as $data) public{{$data->photo}} @endforeach" alt="@foreach($settings as $data) {{$data->photo}} @endforeach">
						</div>
					</div>
				</div>
			</div>
